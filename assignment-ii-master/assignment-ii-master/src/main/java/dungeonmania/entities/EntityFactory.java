...
public class EntityFactory {
    ...
    public SnakeHead buildSnake(Position pos) {
        ...
        double snakeHealthTreasureBuff = config.optDouble("snake_attack_arrow_buff");
        double snakeHealthKeyBuff = config.optDouble("snake_attack_arrow_buff");
        return new SnakeHead(pos, snakeHealth, snakeAttack, snakeHealthTreasureBuff, snakeHealthKeyBuff,
                snakeAttackArrowBuff);
    }
