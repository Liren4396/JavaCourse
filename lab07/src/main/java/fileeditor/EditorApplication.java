...
public class EditorApplication {
    ...
    public EditorApplication(EditorFactory editorFactory) {
        this.frame = editorFactory.setWindowSize();
        this.pane = editorFactory.createDesktopPane();
        this.listener = editorFactory.createActionListener(pane);
        this.menuBar = editorFactory.createMenuBar(listener);
        this.menuBar = editorFactory.createEditMenu(listener);
        this.toolBar = editorFactory.createToolBar(listener);
        this.windowAdapter = editorFactory.createWindowAdapter(pane);
    ...
    public static void main(String[] args) {
        ...
        // EditorFactory editorFactory = new HTMLEditorFactory();
        EditorFactory editorFactory = new TextEditorFactory();
        EditorApplication editor = new EditorApplication(editorFactory);
        editor.setFrameVisible(true);
    }
