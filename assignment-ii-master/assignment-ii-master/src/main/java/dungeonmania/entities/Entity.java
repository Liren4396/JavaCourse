...
public class Entity {
    ...
    private boolean invisiblePotion = false;
    ...
    public void setInvisiblePotion(boolean invisiblePotion) {
        this.invisiblePotion = invisiblePotion;
    }

    public boolean getInvisiblePotion() {
