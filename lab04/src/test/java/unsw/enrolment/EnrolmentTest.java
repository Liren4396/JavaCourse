...
public class EnrolmentTest {
    ...
    public void testComparator() {
        ...
        assertEquals(cs1511Offering.studentsEnrolledInCourse().get(0).getName(), "Andrew Han");
        assertEquals(cs1511Offering.studentsEnrolledInCourse().get(0).getProgram(), 3707);
        assertEquals(cs1511Offering.studentsEnrolledInCourse().get(0).getZid(), "z5204829");
    }
}
